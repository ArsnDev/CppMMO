...
public struct Vec2 : IFlatbufferObject
{
  ...
  public static Offset<CppMMO.Protocol.Vec2> CreateVec2(FlatBufferBuilder builder,
      float x = 0.0f,
      float y = 0.0f) {
  ...
  public static Offset<CppMMO.Protocol.Vec2> EndVec2(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<CppMMO.Protocol.Vec2>(o);
  }
  public Vec2T UnPack() {
    var _o = new Vec2T();
    this.UnPackTo(_o);
  ...
  public static Offset<CppMMO.Protocol.Vec2> Pack(FlatBufferBuilder builder, Vec2T _o) {
    if (_o == null) return default(Offset<CppMMO.Protocol.Vec2>);
    return CreateVec2(
      builder,
      _o.X,
      _o.Y);
