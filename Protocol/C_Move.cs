...
public struct C_Move : IFlatbufferObject
{
  ...
  public CppMMO.Protocol.Vec2? CurrentPosition { get { int o = __p.__offset(4); return o != 0 ? (CppMMO.Protocol.Vec2?)(new CppMMO.Protocol.Vec2()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public long CommandId { get { int o = __p.__offset(12); return o != 0 ? __p.bb.GetLong(o + __p.bb_pos) : (long)0; } }

  public static void StartC_Move(FlatBufferBuilder builder) { builder.StartTable(5); }
  public static void AddCurrentPosition(FlatBufferBuilder builder, Offset<CppMMO.Protocol.Vec2> currentPositionOffset) { builder.AddStruct(0, currentPositionOffset.Value, 0); }
  ...
  public static void AddCommandId(FlatBufferBuilder builder, long commandId) { builder.AddLong(4, commandId, 0); }
...
static public class C_MoveVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyField(tablePos, 4 /*CurrentPosition*/, 8 /*CppMMO.Protocol.Vec2*/, 4, false)
      ...
      && verifier.VerifyField(tablePos, 12 /*CommandId*/, 8 /*long*/, 8, false)
