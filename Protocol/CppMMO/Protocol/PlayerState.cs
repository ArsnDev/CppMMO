...
public struct PlayerState : IFlatbufferObject
{
  ...
  public byte AnimationState { get { int o = __p.__offset(16); return o != 0 ? __p.bb.Get(o + __p.bb_pos) : (byte)0; } }
  public uint LastInputSequence { get { int o = __p.__offset(18); return o != 0 ? __p.bb.GetUint(o + __p.bb_pos) : (uint)0; } }
  ...
  public static Offset<CppMMO.Protocol.PlayerState> CreatePlayerState(FlatBufferBuilder builder,
    ...
    PlayerState.AddAnimationState(builder, animation_state);
    return PlayerState.EndPlayerState(builder);
  }

  public static void StartPlayerState(FlatBufferBuilder builder) { builder.StartTable(8); }
  ...
  public static void AddAnimationState(FlatBufferBuilder builder, byte animationState) { builder.AddByte(6, animationState, 0); }
  public static void AddLastInputSequence(FlatBufferBuilder builder, uint lastInputSequence) { builder.AddUint(7, lastInputSequence, 0); }
...
static public class PlayerStateVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 16 /*AnimationState*/, 1 /*byte*/, 1, false)
      && verifier.VerifyField(tablePos, 18 /*LastInputSequence*/, 4 /*uint*/, 4, false)
