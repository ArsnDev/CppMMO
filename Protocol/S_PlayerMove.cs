...
public struct S_PlayerMove : IFlatbufferObject
{
  ...
  public CppMMO.Protocol.Vec2? CurrentPosition { get { int o = __p.__offset(6); return o != 0 ? (CppMMO.Protocol.Vec2?)(new CppMMO.Protocol.Vec2()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  public CppMMO.Protocol.Vec2? TargetPosition { get { int o = __p.__offset(8); return o != 0 ? (CppMMO.Protocol.Vec2?)(new CppMMO.Protocol.Vec2()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void StartS_PlayerMove(FlatBufferBuilder builder) { builder.StartTable(6); }
  public static void AddPlayerId(FlatBufferBuilder builder, long playerId) { builder.AddLong(0, playerId, 0); }
  public static void AddCurrentPosition(FlatBufferBuilder builder, Offset<CppMMO.Protocol.Vec2> currentPositionOffset) { builder.AddStruct(1, currentPositionOffset.Value, 0); }
  public static void AddTargetPosition(FlatBufferBuilder builder, Offset<CppMMO.Protocol.Vec2> targetPositionOffset) { builder.AddStruct(2, targetPositionOffset.Value, 0); }
...
static public class S_PlayerMoveVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 6 /*CurrentPosition*/, 8 /*CppMMO.Protocol.Vec2*/, 4, false)
      && verifier.VerifyField(tablePos, 8 /*TargetPosition*/, 8 /*CppMMO.Protocol.Vec2*/, 4, false)
