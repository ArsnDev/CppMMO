...
public struct PlayerInfo : IFlatbufferObject
{
  ...
  public CppMMO.Protocol.Vec2? Position { get { int o = __p.__offset(8); return o != 0 ? (CppMMO.Protocol.Vec2?)(new CppMMO.Protocol.Vec2()).__assign(o + __p.bb_pos, __p.bb) : null; } }
  ...
  public static void AddPosition(FlatBufferBuilder builder, Offset<CppMMO.Protocol.Vec2> positionOffset) { builder.AddStruct(2, positionOffset.Value, 0); }
...
static public class PlayerInfoVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 8 /*Position*/, 8 /*CppMMO.Protocol.Vec2*/, 4, false)
