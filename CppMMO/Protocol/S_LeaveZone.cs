...
public struct S_LeaveZone : IFlatbufferObject
{
  ...
  public S_LeaveZoneT UnPack() {
    var _o = new S_LeaveZoneT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(S_LeaveZoneT _o) {
  }
  public static Offset<CppMMO.Protocol.S_LeaveZone> Pack(FlatBufferBuilder builder, S_LeaveZoneT _o) {
    if (_o == null) return default(Offset<CppMMO.Protocol.S_LeaveZone>);
    StartS_LeaveZone(builder);
    return EndS_LeaveZone(builder);
  }
}

public class S_LeaveZoneT
{
