...
public struct PlayerInfo : IFlatbufferObject
{
  ...
  public static Offset<CppMMO.Protocol.PlayerInfo> Pack(FlatBufferBuilder builder, PlayerInfoT _o) {
    ...
    var _position = _o.Position == null ? default(Offset<CppMMO.Protocol.Vec2>) : CppMMO.Protocol.Vec2.Pack(builder, _o.Position);
...
public class PlayerInfoT
{
  ...
  public CppMMO.Protocol.Vec2T Position { get; set; }
